...
vim.api.nvim_set_keymap('n', '<M-j>', '<cmd>lua require"lspsaga.action".smart_scroll_with_saga(1)<CR>', opts)
vim.api.nvim_set_keymap('n', '<M-k>', '<cmd>lua require"lspsaga.action".smart_scroll_with_saga(-1)<CR>', opts)
...
vim.api.nvim_set_keymap('n', 'go', '<cmd>Lspsaga show_cursor_diagnostic<CR>', opts)
